# Configuración exacta de Firebase · Organizador v5.0
...
En el ZIP v5.0 abre el archivo `config.js` con un editor de texto.
...
En **Authentication → Settings / Configuración → Password policy / Política de contraseña** puedes dejar la política predeterminada. Firebase admite un mínimo predeterminado de 6 caracteres y la app v5.0 también exige al menos 6.
...
Cuando inicies sesión desde la app por primera vez, v5.0 creará automáticamente una estructura similar a:
...
# PANTALLA 9 · Subir v5.0 a GitHub

1. Descomprime `organizador-personal-inteligente-v5.0-github.zip`.
...
1. Publica v5.0 en GitHub Pages.
...
1. Abre la PWA de Windows actualizada a v5.0.
...
3. que la versión publicada es v5.0;
...
Esta v5.0 no necesita ninguno de estos archivos, pero si algún día Firebase te los ofrece para un servidor, no los publiques:
